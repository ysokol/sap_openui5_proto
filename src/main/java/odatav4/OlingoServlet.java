...
public class OlingoServlet extends HttpServlet {
    ...
    //private static final Logger LOG = LoggerFactory.getLoggeOlingoServletet().class;
    ...
    protected void service(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            ServiceMetadata edm = odata.createServiceMetadata(new MaintEdmProvider(), new ArrayList<EdmxReference>());
            ODataHttpHandler handler = odata.createHandler(edm);
            handler.register(new MyDefaultProcessor());
            handler.register(new MaintEntityCollectionProcessor());
